...
// llgo:type C
type StructuredErrorFunc func(unsafe.Pointer, ErrorPtr)
...
//go:linkname ParserPrintFileInfo C.xmlParserPrintFileInfo
func ParserPrintFileInfo(input ParserInputPtr)

//go:linkname ParserPrintFileContext C.xmlParserPrintFileContext
func ParserPrintFileContext(input ParserInputPtr)

/*
 * Extended error information routines
 */
//go:linkname GetLastError C.xmlGetLastError
func GetLastError() ErrorPtr

//go:linkname ResetLastError C.xmlResetLastError
func ResetLastError()

//go:linkname CtxtGetLastError C.xmlCtxtGetLastError
func CtxtGetLastError(ctx unsafe.Pointer) ErrorPtr
...
//go:linkname CopyError C.xmlCopyError
func CopyError(from ErrorPtr, to ErrorPtr) c.Int
