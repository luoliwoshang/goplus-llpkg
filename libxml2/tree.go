...
func SetTreeDoc(tree NodePtr, doc DocPtr)

//go:linkname SetListDoc C.xmlSetListDoc
func SetListDoc(list NodePtr, doc DocPtr)
...
func NodeSetContent(cur NodePtr, content *Char)

//go:linkname NodeSetContentLen C.xmlNodeSetContentLen
func NodeSetContentLen(cur NodePtr, content *Char, len c.Int)

//go:linkname NodeAddContent C.xmlNodeAddContent
func NodeAddContent(cur NodePtr, content *Char)

//go:linkname NodeAddContentLen C.xmlNodeAddContentLen
func NodeAddContentLen(cur NodePtr, content *Char, len c.Int)
...
func NodeSetLang(cur NodePtr, lang *Char)

//go:linkname NodeSetSpacePreserve C.xmlNodeSetSpacePreserve
func NodeSetSpacePreserve(cur NodePtr, val c.Int)
...
func NodeSetBase(cur NodePtr, uri *Char)
