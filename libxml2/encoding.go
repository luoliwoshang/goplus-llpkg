...
func (recv_ *CharEncodingHandler) CharEncOutFunc(out BufferPtr, in BufferPtr) c.Int {
	return 0
}

// llgo:link (*CharEncodingHandler).CharEncInFunc C.xmlCharEncInFunc
func (recv_ *CharEncodingHandler) CharEncInFunc(out BufferPtr, in BufferPtr) c.Int {
	return 0
}

// llgo:link (*CharEncodingHandler).CharEncFirstLine C.xmlCharEncFirstLine
func (recv_ *CharEncodingHandler) CharEncFirstLine(out BufferPtr, in BufferPtr) c.Int {
	return 0
}
